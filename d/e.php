                ...
                <div class="card shadow-lg border-0 rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="f.php" method="POST">
                            ...
                            <div class="mb-5">
                                <label for="resumeFile" class="form-label">แนบ Resume/CV (PDF, DOCX) <span class="text-danger">*</span></label>
                                <input class="form-control" type="file" id="resumeFile" name="resumeFile" accept=".pdf,.docx" required>
                                <div class="form-text">ขนาดไฟล์ไม่เกิน 5 MB.</div>
                            </div>
                            
                            <div class="d-grid">
                                <button type="submit" class="btn btn-success btn-lg">ส่งใบสมัคร</button>
                            </div>
